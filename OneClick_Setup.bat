...
echo.
echo [Step 2/5] Installing dependencies via pip...
python -m pip install --upgrade pip >nul 2>&1
python -m pip install -r requirements.txt
echo        [OK] All dependencies installed successfully!
echo.
echo [Step 3/5] Setting up Windows Auto-Start and Browser Protocol...
...
echo.
echo [Step 5/5] Launching ZDownloader Backend in Background...
